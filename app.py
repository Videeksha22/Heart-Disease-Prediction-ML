...
model = joblib.load(os.path.join(BASE_DIR, "model", "knn_heart_model.pkl"))
scaler = joblib.load(os.path.join(BASE_DIR, "model", "heart_scaler.pkl"))
expected_columns = joblib.load(os.path.join(BASE_DIR, "model", "heart_columns.pkl"))
